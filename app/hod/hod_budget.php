        ...
        <div class="container-fluid">
            ...
            <div class="row col-md-12">
                <div class="dropdown col-md-4 col-xs-offset-4 row">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right drop">
                        <li><a href="hod_budget.php?category=0">UNAPPROVED BUDGETS</a></li>
                        <li><a href="hod_budget.php?category=1">APPROVED BUDGETS</a></li>
                        <li><a href="hod_budget.php?category=all">ALL BUDGETS</a></li>
                    </ul>
                </div>
            </div><!-- /.row -->
            ...
            <div class="col-md-7 doc-table">
                <?php
                    ...
                    $hod->approve_or_disapprove("budget",array('set_col'=>'is_approved','where_col'=>'uniq_id'));
                ?>
